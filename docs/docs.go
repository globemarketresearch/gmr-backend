    ...
    "paths": {
        ...
        "/api/v1/authors": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Author data (name is required with min 2 chars, role, bio, linkedinUrl, and xUrl are optional. linkedinUrl and xUrl must be valid HTTPS URLs)",
                        "name": "author",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/authors/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Updated author data (all fields are optional for partial updates. linkedinUrl and xUrl can be updated or cleared, must be a valid HTTPS URL if provided)",
                        "name": "author",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/blogs/{id}/cancel-schedule": {
            "patch": {
        ...
        "/api/v1/categories/{id}/image": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "file",
                        "description": "Image file (max 10MB, allowed types: JPEG, PNG, WebP)",
                        "name": "file",
                        "in": "formData",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "Category with updated image URL",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
        ...
        "/api/v1/categories/{slug}/industry-news": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "List of industry news articles with pagination",
                        "schema": {
                            "$ref": "#/definitions/industry_news.IndustryNewsListResponse"
                        }
                    },
                    "500": {
                        "description": "Internal server error",
        ...
        "/api/v1/categories/{slug}/press-releases": {
            "get": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/dashboard.ActivityResponse"
                                        }
                                    }
                                }
                            ]
        ...
        "/api/v1/industry-news": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Set to 'true' to list soft-deleted (trashed) articles",
                        "name": "deleted",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Sort order: publish_date_desc, created_at_desc, updated_at_desc",
                        "name": "sort_by",
                        "in": "query"
                    },
                    {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Industry news data",
                        "name": "industryNews",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/industry_news.CreateIndustryNewsRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Industry news article created successfully",
                        "schema": {
                            "$ref": "#/definitions/industry_news.IndustryNewsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad request - invalid input or validation error",
        ...
        "/api/v1/industry-news/images/{imageId}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/industry_news.IndustryNewsImage"
                                        }
                                    }
                                }
                            ]
        ...
        "/api/v1/industry-news/slug/{slug}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Industry news article slug",
                        "name": "slug",
                        "in": "path",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "Industry news article details",
                        "schema": {
                            "$ref": "#/definitions/industry_news.IndustryNewsResponse"
                        }
                    },
                    ...
                    "404": {
                        "description": "Industry news article not found",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
        ...
        "/api/v1/industry-news/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Industry news article ID",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Industry news update data",
                        "name": "industryNews",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/industry_news.UpdateIndustryNewsRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Industry news article updated successfully",
                        "schema": {
                            "$ref": "#/definitions/industry_news.IndustryNewsResponse"
                        }
                    },
            ...
            "delete": {
                ...
                "responses": {
                    "204": {
                        "description": "Industry news article deleted successfully"
                    },
                    "400": {
                        "description": "Bad request - invalid ID",
                        "schema": {
        ...
        "/api/v1/industry-news/{id}/cancel-schedule": {
            "patch": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/industry-news/{id}/publish": {
            "patch": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "Industry news article published successfully",
                        "schema": {
                            "$ref": "#/definitions/industry_news.IndustryNewsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad request - invalid ID or article cannot be published",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
        ...
        "/api/v1/industry-news/{id}/restore": {
            "patch": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "Industry news article restored successfully",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
        ...
        "/api/v1/industry-news/{id}/schedule": {
            "patch": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "Industry news article scheduled successfully",
                        "schema": {
                            "$ref": "#/definitions/industry_news.IndustryNewsResponse"
                        }
                    },
        ...
        "/api/v1/industry-news/{id}/soft-delete": {
            "patch": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "Industry news article moved to trash successfully",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
        ...
        "/api/v1/industry-news/{id}/submit-review": {
            "patch": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "Industry news article submitted for review successfully",
                        "schema": {
                            "$ref": "#/definitions/industry_news.IndustryNewsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad request - invalid ID or article cannot be submitted",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
        ...
        "/api/v1/industry-news/{id}/unpublish": {
            "patch": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "Industry news article unpublished successfully",
                        "schema": {
                            "$ref": "#/definitions/industry_news.IndustryNewsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad request - invalid ID or article is not published",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
        ...
        "/api/v1/industry-news/{newsId}/images": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Bad request - invalid industry news ID",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
        ...
        "/api/v1/media-mentions": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "List of media mentions with pagination metadata",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/mediamention.MediaMention"
                                            }
                                        },
                                        "meta": {
                                            "$ref": "#/definitions/response.Meta"
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Media mention data (title is required, link must be a valid URL if provided)",
                        "name": "mediaMention",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/media-mentions/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Updated media mention data",
                        "name": "mediaMention",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/media-mentions/{id}/image": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/orders": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Search by customer name/email/company/report",
                        "name": "search",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "Sort field: createdAt, amount, status",
                        "name": "sortBy",
                        "in": "query"
                    },
                    {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/order.OrderStats"
                                        }
                                    }
                                }
                            ]
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/order.CaptureOrderResponse"
                        }
                    },
                    "400": {
                        "description": "Bad request",
        ...
        "/api/v1/orders/{id}/stripe-capture": {
            "post": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/order.ConfirmStripeOrderResponse"
                        }
                    },
                    "400": {
                        "description": "Bad request",
        ...
        "/api/v1/press-releases/{id}/cancel-schedule": {
            "patch": {
        ...
        "/api/v1/press-releases/{id}/restore": {
            "patch": {
                ...
                "responses": {
                    "200": {
                        "description": "Press release restored successfully",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
        ...
        "/api/v1/press-releases/{id}/schedule": {
            "patch": {
        ...
        "/api/v1/press-releases/{id}/soft-delete": {
            "patch": {
                ...
                "responses": {
                    "200": {
                        "description": "Press release moved to trash successfully",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
        ...
        "/api/v1/redirects": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Search in source URL, destination URL, notes",
                        "name": "search",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "List of redirects with pagination",
                        "schema": {
                            "$ref": "#/definitions/redirect.RedirectListResponse"
                        }
                    },
                    "500": {
                        "description": "Internal server error",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/redirect.CreateRedirectRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/redirect.RedirectResponse"
                        }
                    },
                    "400": {
                        "description": "Bad request",
        ...
        "/api/v1/redirects/bulk": {
            "delete": {
                ...
                "parameters": [
                    {
                        "description": "Array of redirect IDs to delete",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/redirect.BulkDeleteRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Redirects deleted successfully",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
        ...
        "/api/v1/redirects/hit/{id}": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Hit count incremented",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/redirect.UpdateRedirectRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/redirects/{id}/toggle": {
            "patch": {
                ...
                "responses": {
                    "200": {
                        "description": "Redirect toggled successfully",
                        "schema": {
                            "$ref": "#/definitions/redirect.RedirectResponse"
                        }
                    },
        ...
        "/api/v1/reports": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Admin only: Show deleted reports (true/false, default: false)",
                        "name": "deleted",
                        "in": "query"
                    },
                    {
        ...
        "/api/v1/reports/{id}": {
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "Report permanently deleted successfully",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
        ...
        "/api/v1/reports/{id}/cancel-schedule": {
            "patch": {
        ...
        "/api/v1/sitemap/blogs": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Items per page (default: 1000, max: 1000)",
                        "name": "limit",
                        "in": "query"
                    }
                ],
    ...
    "definitions": {
        ...
        "blog.Blog": {
            ...
            "properties": {
                ...
                "internalLinks": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/blog.InternalLinkEntry"
                    }
                },
                "location": {
                    "type": "string"
        ...
        "blog.InternalLinkEntry": {
            ...
            "properties": {
                ...
                "targetType": {
                    "description": "\"report\", \"blog\", \"press-release\"",
                    "type": "string"
                },
                "targetUrl": {
                    "type": "string"
        ...
        "dashboard.Activity": {
            ...
            "properties": {
                ...
                "type": {
                    "description": "ActivityType as string",
                    "type": "string"
                },
                "user": {
        ...
        "dashboard.ContentCreationStats": {
            "type": "object",
            "properties": {
                "blogsThisMonth": {
                    "type": "integer"
                },
                "pressReleasesThisMonth": {
                    "type": "integer"
                },
                "reportsThisMonth": {
                    "type": "integer"
        ...
        "dashboard.DashboardStats": {
            ...
            "properties": {
                "blogs": {
                    "$ref": "#/definitions/dashboard.BlogStats"
                },
                "contentCreation": {
                    "$ref": "#/definitions/dashboard.ContentCreationStats"
                },
                "leads": {
                    "$ref": "#/definitions/dashboard.LeadStats"
                },
                "performance": {
                    "$ref": "#/definitions/dashboard.PerformanceStats"
                },
                "pressReleases": {
                    "$ref": "#/definitions/dashboard.PressReleaseStats"
                },
                "reports": {
                    "$ref": "#/definitions/dashboard.ReportStats"
                },
                "users": {
        ...
        "dashboard.LeadStats": {
            ...
            "properties": {
                ...
                "recent": {
                    "$ref": "#/definitions/dashboard.RecentLeadStats"
                },
                "total": {
                    "type": "integer"
                }
        ...
        "dashboard.PerformanceStats": {
            ...
            "properties": {
                "topCategories": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dashboard.TopCategory"
                    }
                },
                "topReports": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dashboard.TopReport"
                    }
                }
            }
        },
        "dashboard.PressReleaseStats": {
            "type": "object",
            "properties": {
                "change": {
                    "type": "number"
        ...
        "form.FormCategory": {
            ...
            "x-enum-varnames": [
                ...
                "CategoryRequestCustomization",
                "CategoryScheduleDemo",
                "CategoryNewsletter",
                "CategoryPublishNews"
            ]
        },
        ...
        "industry_news.CreateIndustryNewsRequest": {
            "type": "object",
            "required": [
                "authorId",
                "categoryId",
            ...
            "properties": {
                ...
                "metadata": {
                    "$ref": "#/definitions/industry_news.IndustryNewsMetadata"
                },
                "publishDate": {
                    "type": "string"
                },
                "status": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/industry_news.IndustryNewsStatus"
                        }
                    ]
                },
                "tags": {
        ...
        "industry_news.IndustryNews": {
            ...
            "properties": {
                ...
                "internalLinks": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/industry_news.InternalLinkEntry"
                    }
                },
                "location": {
                    "type": "string"
        ...
        "industry_news.IndustryNewsImage": {
            ...
            "properties": {
                ...
                "industry_news": {
                    "$ref": "#/definitions/industry_news.IndustryNews"
                },
                "industry_news_id": {
                    "type": "integer"
                },
        ...
        "industry_news.IndustryNewsListResponse": {
            "type": "object",
            "properties": {
                "industryNews": {
                    "type": "array",
        ...
        "industry_news.IndustryNewsMetadata": {
            "type": "object",
            "properties": {
                "keywords": {
                    "type": "array",
        ...
        "industry_news.IndustryNewsResponse": {
            "type": "object",
            "properties": {
                "industryNews": {
                    "$ref": "#/definitions/industry_news.IndustryNews"
        ...
        "industry_news.IndustryNewsStatus": {
            "type": "string",
            "enum": [
                "draft",
                "review",
        ...
        "industry_news.InternalLinkEntry": {
            "type": "object",
            "properties": {
                "keyword": {
                    "type": "string"
                ...
                "targetType": {
                    "description": "\"report\", \"blog\", \"press-release\", \"industry-news\"",
                    "type": "string"
                },
                "targetUrl": {
                    "type": "string"
        ...
        "industry_news.UpdateIndustryNewsRequest": {
            "type": "object",
            "properties": {
                "authorId": {
                    "type": "integer"
        ...
        "order.ConfirmStripeOrderResponse": {
            "type": "object",
            "properties": {
                "order_id": {
                    "type": "integer"
        ...
        "order.CreateOrderRequest": {
            ...
            "properties": {
                ...
                "payment_method": {
                    "description": "PaymentMethod selects the payment gateway: \"paypal\" (default) or \"stripe\".",
                    "type": "string"
                },
                "report_slug": {
                    "type": "string"
        ...
        "press_release.InternalLinkEntry": {
            "type": "object",
            "properties": {
                "keyword": {
                    "type": "string"
        ...
        "press_release.PressRelease": {
            ...
            "properties": {
                ...
                "internalLinks": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/press_release.InternalLinkEntry"
                    }
                },
                "location": {
                    "type": "string"
        ...
        "redirect.CreateRedirectRequest": {
            "type": "object",
            "properties": {
                "destinationUrl": {
                    "type": "string"
        ...
        "redirect.UpdateRedirectRequest": {
            "type": "object",
            "properties": {
                "destinationUrl": {
                    "type": "string"
        ...
        "report.Report": {
            ...
            "properties": {
                ...
                "internal_links": {
                    "description": "Internal links configuration",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/report.InternalLinkEntry"
                    }
                },
                "internal_notes": {
                    "type": "string"
